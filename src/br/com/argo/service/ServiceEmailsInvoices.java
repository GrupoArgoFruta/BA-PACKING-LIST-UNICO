...
public class ServiceEmailsInvoices {
	String msg;
	public void enviarEmailComAnexos(EntityFacade dwfEntityFacade, ContextoAcao contexto, byte[] bytesPdfInvoice,
			 String assunto, String mensagem,String emailclient) throws Exception {
...
//			dynamicVO4EmailCopia.setProperty("EMAIL", emaildest.trim());
////			dynamicVO4EmailCopia.setProperty("EMAIL", "log@argofruta.com");
...
//			contexto.setMensagemRetorno("O e-mail do usuário logado é: " + (emaildest != null ? emaildest : "Nenhum e-mail encontrado."));
		} catch (Exception e) {
			e.printStackTrace();
