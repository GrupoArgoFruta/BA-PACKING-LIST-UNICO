...
public class Repository_ClientFreshSolutions {
	public void clienteFreshSolutions(ContextoAcao ctx, BigDecimal codparc, BigDecimal nuanexo, Registro registro) {
	    ...
	    try {
	        ...
	        // Gere o relatório principal (packing list clienteFreshSolutions)
	        ...
	        SessionFile sessionFilePcklist = SessionFile.createSessionFile("PACKING_LIST_OGL.xls", "PACKING_LIST_FRESHSOLUTIONS", excelBytesPackinglist);
	     ...
	     // Construindo o assunto do email
	        ...
	        emailsAnexos.enviarEmailComAnexos(dwfFacade, ctx, excelBytesPackinglist,null,assunto, mensagem,emailParam,emailcliente,emailGrupo);

	    } catch (Exception e) {
	        // Handle exception
	        e.printStackTrace();
	        ctx.setMensagemRetorno("Erro ao executar clienteFreshSolutions: " + e.getMessage());
	    } finally {
